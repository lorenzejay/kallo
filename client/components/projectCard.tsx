  ...
  return (
    <Link href={`/projects/${projectId}`} key={projectId}>
      <div
        ...
        } shadow-xl rounded-md h-auto cursor-pointer w-96 md:w-72 relative p-3 pb-10 mt-3 hover:transform hover:shadow-2xl transition-all duration-300 ease-in-out`}
      >
        <img
